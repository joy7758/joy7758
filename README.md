...
- [#3419：增加外部评估器交接示例](https://github.com/microsoft/agent-governance-toolkit/pull/3419)
  把 `DecisionBOM` 观察结果转换为确定性的外部评估请求；交接保持只读，
  不授予执行权限，也不把评估结果直接变成治理决定；已于 2026 年 9 月 13 日合并。
...
项目成熟度最近一次审计快照：2026 年 8 月 8 日；论文状态最近一次核验：2026 年 8 月 15 日；外部 PR 状态最近一次核验：2026 年 9 月 24 日。仓库版本、依赖、CI 或可见范围发生变化后，以上结论都需要重新核对。
