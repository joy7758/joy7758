# Outbound Entry Priority

| Context | Primary repo to share | Secondary repo | Why |
| --- | --- | --- | --- |
| Someone asks for the overall system | `digital-biosphere-architecture` | `persona-object-protocol` | Start with the canonical system view, then move to the clearest concept entry. |
